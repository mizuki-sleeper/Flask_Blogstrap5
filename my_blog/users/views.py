...
from my_blog.models import User, BlogPost, BlogCategory
from my_blog.users.forms import RegistrationForm, LoginForm, UpdateUserForm
from my_blog.main.forms import BlogSearchForm
...
def user_posts(user_id):
    ...
    # ブログ記事の取得
    page = request.args.get('page', 1, type=int)
    blog_posts = BlogPost.query.filter_by(user_id=user_id).order_by(
